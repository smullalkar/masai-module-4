...
import { clas, filterClass4, deleteStudent } from '../../Redux/Actions';
...
class Class4 extends Component {
    ...
    render() {
        const { c_data, match, filterClass4, fil4, filteredData_c4, deleteStudent } = this.props
        ...
        if (!fil4) {
            return (
                <main>
                    ...
                    <Box display="flex" justifyContent="center" m={1} p={1} bgcolor="background.paper">
                        <Button
                            onClick={() => { filterClass4(this.state) }}
                            variant="contained"
                            color="secondary">
                            Apply
                            </Button>
                ...
                <main>
                    ...
                    <TableContainer component={Paper}>
                        <Table ria-label="caption table">
                            ...
                            <TableBody>
                                {filteredData_c4 && filteredData_c4.map((row) => (
                                    <TableRow hover key={uuidv4()} style={{ backgroundColor: row.grade === 'FAIL' ? '#c5cae9' : 'none' }}>
...
const mapStateToProps = state => {
    console.log('all students data', state.filteredData_c4)
    return {
        c_data: state.c_data,
        fil4: state.fil4,
        filteredData_c4: state.filteredData_c4.data
    };
};
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        filterClass4: a => dispatch(filterClass4(a)),
