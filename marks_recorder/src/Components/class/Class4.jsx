...
import { class4Details } from '../../Redux/Actions';
...
class Class4 extends Component {
    componentDidMount = () => {
        this.props.class4Details()
    }
    render() {
        const { class4, match } = this.props
        return (
            <main>
                <Toolbar />
                <TableContainer component={Paper}>
                    <Table ria-label="caption table">
                        ...
                        <TableHead>
                            <TableRow hover style={{ backgroundColor: '#d34f4f' }}>
...
const mapStateToProps = state => {
    console.log('all students data', state.class4.data)
    return {
        class4: state.class4.data
    };
};

const mapDispatchToProps = dispatch => {
    return {
        class4Details: a => dispatch(class4Details(a)),
    };
};
