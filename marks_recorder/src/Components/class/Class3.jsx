...
import { class3Details } from '../../Redux/Actions';
...
class Class3 extends Component {
    componentDidMount = () => {
        this.props.class3Details()
    }
    render() {
        const { class3, match } = this.props
        return (
            <main>
                <Toolbar />
                <TableContainer component={Paper}>
                    <Table ria-label="caption table">
                        ...
                        <TableHead>
                            <TableRow hover style={{ backgroundColor: '#d33f3f' }}>
...
const mapStateToProps = state => {
    console.log('all students data', state.class3.data)
    return {
        class3: state.class3.data
    };
};

const mapDispatchToProps = dispatch => {
    return {
        class3Details: a => dispatch(class3Details(a)),
    };
};
