...
import { clas, filterClass10, deleteStudent } from '../../Redux/Actions';
...
class Class10 extends Component {
    ...
    render() {
        const { c_data, match, filterClass10, fil10, filteredData_c10, deleteStudent } = this.props
        ...
        if (!fil10) {
            return (
                <main>
                    ...
                    <Box display="flex" justifyContent="center" m={1} p={1} bgcolor="background.paper">
                        <Button
                            onClick={() => { filterClass10(this.state) }}
                            variant="contained"
                            color="secondary">
                            Apply
                            </Button>
                ...
                <main>
                    ...
                    <TableContainer component={Paper}>
                        <Table ria-label="caption table">
                            ...
                            <TableBody>
                                {filteredData_c10 && filteredData_c10.map((row) => (
                                    <TableRow hover key={uuidv4()} style={{ backgroundColor: row.grade === 'FAIL' ? '#c5cae9' : 'none' }}>
...
const mapStateToProps = state => {
    console.log('all students data', state.filteredData_c10)
    return {
        c_data: state.c_data,
        fil10: state.fil10,
        filteredData_c10: state.filteredData_c10.data
    };
};
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        filterClass10: a => dispatch(filterClass10(a)),
