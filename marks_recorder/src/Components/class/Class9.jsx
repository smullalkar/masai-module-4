...
import { clas, filterClass9, deleteStudent } from '../../Redux/Actions';
...
class Class9 extends Component {
    ...
    render() {
        const { c_data, match, filterClass9, fil9, filteredData_c9, deleteStudent } = this.props
        ...
        if (!fil9) {
            return (
                <main>
                    ...
                    <Box display="flex" justifyContent="center" m={1} p={1} bgcolor="background.paper">
                        <Button
                            onClick={() => { filterClass9(this.state) }}
                            variant="contained"
                            color="secondary">
                            Apply
                            </Button>
                ...
                <main>
                    ...
                    <TableContainer component={Paper}>
                        <Table ria-label="caption table">
                            ...
                            <TableBody>
                                {filteredData_c9 && filteredData_c9.map((row) => (
                                    <TableRow hover key={uuidv4()} style={{ backgroundColor: row.grade === 'FAIL' ? '#c5cae9' : 'none' }}>
...
const mapStateToProps = state => {
    console.log('all students data', state.filteredData_c9)
    return {
        c_data: state.c_data,
        fil9: state.fil9,
        filteredData_c9: state.filteredData_c9.data
    };
};
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        filterClass9: a => dispatch(filterClass9(a)),
