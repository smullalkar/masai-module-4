...
import { clas, filterClass5, deleteStudent } from '../../Redux/Actions';
...
class Class5 extends Component {
    ...
    render() {
        const { c_data, match, filterClass5, fil5, filteredData_c5, deleteStudent } = this.props
        ...
        if (!fil5) {
            return (
                <main>
                    ...
                    <Box display="flex" justifyContent="center" m={1} p={1} bgcolor="background.paper">
                        <Button
                            onClick={() => { filterClass5(this.state) }}
                            variant="contained"
                            color="secondary">
                            Apply
                            </Button>
                ...
                <main>
                    ...
                    <TableContainer component={Paper}>
                        <Table ria-label="caption table">
                            ...
                            <TableBody>
                                {filteredData_c5 && filteredData_c5.map((row) => (
                                    <TableRow hover key={uuidv4()} style={{ backgroundColor: row.grade === 'FAIL' ? '#c5cae9' : 'none' }}>
...
const mapStateToProps = state => {
    console.log('all students data', state.filteredData_c5)
    return {
        c_data: state.c_data,
        fil5: state.fil5,
        filteredData_c5: state.filteredData_c5.data
    };
};
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        filterClass5: a => dispatch(filterClass5(a)),
