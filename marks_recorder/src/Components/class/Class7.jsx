...
import { clas, filterClass7, deleteStudent } from '../../Redux/Actions';
...
class Class7 extends Component {
    ...
    render() {
        const { c_data, match, filterClass7, fil7, filteredData_c7, deleteStudent } = this.props
        ...
        if (!fil7) {
            return (
                <main>
                    ...
                    <Box display="flex" justifyContent="center" m={1} p={1} bgcolor="background.paper">
                        <Button
                            onClick={() => { filterClass7(this.state) }}
                            variant="contained"
                            color="secondary">
                            Apply
                            </Button>
                ...
                <main>
                    ...
                    <TableContainer component={Paper}>
                        <Table ria-label="caption table">
                            ...
                            <TableBody>
                                {filteredData_c7 && filteredData_c7.map((row) => (
                                    <TableRow hover key={uuidv4()} style={{ backgroundColor: row.grade === 'FAIL' ? '#c5cae9' : 'none' }}>
...
const mapStateToProps = state => {
    console.log('all students data', state.filteredData_c7)
    return {
        c_data: state.c_data,
        fil7: state.fil7,
        filteredData_c7: state.filteredData_c7.data
    };
};
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        filterClass7: a => dispatch(filterClass7(a)),
