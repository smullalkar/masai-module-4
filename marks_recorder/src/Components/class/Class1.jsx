...
import { class1Details } from '../../Redux/Actions';
...
class Class1 extends Component {
    componentDidMount = () => {
        this.props.class1Details()
    }
    render() {
        const { class1, match } = this.props
        return (
            <main>
                <Toolbar />
...
const mapStateToProps = state => {
    console.log('all students data', state.class1.data)
    return {
        class1: state.class1.data
    };
};

const mapDispatchToProps = dispatch => {
    return {
        class1Details: a => dispatch(class1Details(a)),
    };
};
